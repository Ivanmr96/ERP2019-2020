Vue.component('detallescomponent', {
            data: function()
            {
                return {
                    //idLineaPedido: id,
                    pedidoSeleccionado: store.state.pedidoSeleccionado,
            ...
            methods:
            {
                ...
                anadirLineaPedidos(){
                    ...
                    //alert(store.state.pedidoSeleccionado.lineasDePedido.length)
                },
    ...
    computed:
    {
        lineasPedidoDelpedidoSeleccionado:function(){
            return this.$store.state.pedidoSeleccionado.lineasDePedido
        },
