Vue.component('menucomponent', {
    ...
    <div class="menuLatIzq w3-sidebar w3-bar-block sidebar" style="width:13%">
        ...
        <a href="#" v-on:click="$store.state.currentComponent = $store.state.components.login" class="btn-navbar btn btn-logout text-left"><i data-toggle="tooltip" title="Logout" class="material-icons align-bottom">home</i> Log out</a>
